...
var checkOptions = function (result, option) {
    ...
    if (option.insertSymbol) {
        var characters = option.charset === "number" ? (types_1.number + types_1.symbols) :
            option.charset === "alphabet" ? (types_1.alphabet + types_1.symbols) :
                (types_1.alphanumeric + types_1.symbols);
