...
var generate = function (option) {
    ...
    if (typeof option === 'number' || !option) {
        ...
        for (var i = 0; i < opt; i += 1) {
            result += characters.charAt(Math.floor((0, cryptorandomt_1.getCryptoRandomInt)(charactersLength)));
        }
    }
        ...
        if (option.range) {
            ...
            result = Math.round((0, cryptorandomt_1.getCryptoRandomInt)(Number(Math.pow(10, option.length)).toString()));
            result = (0, check_option_1.checkOptions)(String(result), option);
        }
        else if (option.charset === 'binary') {
            for (var i = 0; i < option.length; ++i) {
                result += Math.floor((0, cryptorandomt_1.getCryptoRandomInt)(2));
            }
        }
        else if (option.charset === 'octal') {
            for (var i = 0; i < option.length; ++i) {
                result += Math.floor((0, cryptorandomt_1.getCryptoRandomInt)(8));
            }
        }
        else if (option.charset === 'hex') {
            var charactersLength = types_1.hex.length;
            for (var i = 0; i < option.length; i += 1) {
                result += types_1.hex.charAt(Math.floor((0, cryptorandomt_1.getCryptoRandomInt)(charactersLength)));
            }
            result = (0, check_option_1.checkOptions)(result, option);
        }
            ...
            for (var i = 0; i < option.length; i += 1) {
                result += types_1.alphabet.charAt(Math.floor((0, cryptorandomt_1.getCryptoRandomInt)(charactersLength)));
            }
            result = (0, check_option_1.checkOptions)(result, option);
        }
        else {
            ...
            for (var i = 0; i < option.length; i += 1) {
                console.log(result);
                result += types_1.alphanumeric.charAt(Math.floor((0, cryptorandomt_1.getCryptoRandomInt)(charactersLength)));
            }
            result = (0, check_option_1.checkOptions)(result, option);
        }
    }
...
var generateUnicodeEmoji = function (length) {
    ...
    for (var i = 0; i < len; i += 1) {
        result += emoji_1.emojis[Math.floor((0, cryptorandomt_1.getCryptoRandomInt)(charactersLength))].trim();
    }
    return result;
};
