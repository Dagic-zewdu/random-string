...
exports.alphabetSymbol = 'IJ[A-B!C$Dh%E^FGH&Kf\gL*f(zMNy)Q_iOfPe+xdRc|zb~S=aTw`{Y}X\[]Z\vrW:j";k<ls>t?mVn,o.up\/]Uq' + "'";
exports.numberSymbol = '[-!$%9^&*()_8+|~6=7`5{4}\[\]3:"2;<>?0,.1\/]' + "'";
exports.alphabetNumericSymbol = 'IJ[0A-B!1C$3Dh%E^2FGH&4Kf5\gL*6f(zMN7y)Q_iOfPe+xdRc|zb~S=aTw`{Y}X\[]Z\vrW:j";k<ls8>t?9mVn,o.u7p\/]Uq' + "'";
